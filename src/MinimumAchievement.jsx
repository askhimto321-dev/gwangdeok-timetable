...
export default function MinimumAchievement({db={},persist,actor,accessRole="teacher",grade="2",roster={},allRosters={},homeroomClass="",showToast}){
  ...
  return <div className="minimum-achievement minimum-dashboard-print-area" style={ui.root}>
    ...
    <section className="minimum-rule-grid" style={ui.ruleGrid}>
      ...
      <div style={ui.ruleCard}><span style={{...ui.ruleIcon,...ui.electiveIcon}}><BookOpenCheck size={18}/></span><div><b>선택과목</b><strong>출석률 2/3 이상</strong><small>학업성취율 40% 기준은 최소성취수준 판정에 적용하지 않습니다.</small></div></div>
    </section>
...
const css=`
.minimum-achievement *{box-sizing:border-box}.minimum-achievement{letter-spacing:-.028em}.minimum-achievement button,.minimum-achievement input,.minimum-achievement select{font-family:${FONT};letter-spacing:-.028em}.minimum-achievement button:disabled{cursor:not-allowed}
.minimum-achievement h2{margin:7px 0 8px;font-size:23px;letter-spacing:-.045em}.minimum-achievement header p{margin:0;font-size:12.5px;line-height:1.65;opacity:.88}
...
@media(max-width:850px){.minimum-achievement .minimum-rule-grid{grid-template-columns:1fr!important}.minimum-achievement .minimum-hero{align-items:flex-start!important;flex-direction:column!important}.minimum-achievement .minimum-bulk-grid{grid-template-columns:1fr!important}}
