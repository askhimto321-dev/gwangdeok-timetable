...
try{
 ...
 if(parsed.errors.length||parsed.rows.length!==805)throw new Error(`Catalog errors=${parsed.errors.length}, rows=${parsed.rows.length}`);
 fs.writeFileSync('/tmp/kd98-workbook/rows.json',JSON.stringify(parsed.rows));
