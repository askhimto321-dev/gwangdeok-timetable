...
try{
 ...
 if(parsed.errors.length||parsed.rows.length!==804)throw new Error(`Catalog errors=${parsed.errors.length}, rows=${parsed.rows.length}`);
 fs.writeFileSync('../outputs/kd100/rows.json',JSON.stringify(parsed.rows));
