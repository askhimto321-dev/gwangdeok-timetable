    ...
    <div className="teacher-grade-analyzer" style={ui.root}>
      ...
      <section style={ui.section}>
        ...
        <div style={ui.settingsGrid}>
          ...
          <div className="teacher-grade-setting-card performance-setting-card" style={ui.settingCard}>
          ...
          <div className="teacher-grade-setting-card criteria-setting-card" style={ui.settingCard}>
...
@media(max-width:720px){.teacher-grade-analyzer .teacher-grade-tie-student{grid-template-columns:1fr 1fr}.teacher-grade-analyzer .teacher-grade-workspace-browser{grid-template-columns:1fr!important}.teacher-grade-analyzer .teacher-grade-weight-row{grid-template-columns:1fr!important;align-items:flex-start!important;gap:8px!important}.teacher-grade-analyzer .teacher-grade-weight-row>span:last-child{width:100%;justify-content:flex-end}}

.teacher-grade-analyzer .teacher-grade-setting-caption{display:block!important;max-width:230px;margin-top:6px!important;color:#6f7f93!important;font-size:10.5px!important;font-weight:700!important;line-height:1.62!important;white-space:normal!important;word-break:keep-all!important}
.teacher-grade-analyzer .teacher-grade-setting-card{overflow:hidden}.teacher-grade-analyzer .teacher-grade-setting-card .teacher-grade-weight-row:last-of-type{border-bottom-color:#dce6f0}.teacher-grade-analyzer .teacher-grade-weight-row>span:first-child>b{font-size:12.2px;line-height:1.5!important}.teacher-grade-analyzer .teacher-grade-weight-row>span:first-child>small{margin-top:5px!important;line-height:1.5!important}.teacher-grade-analyzer .performance-area-row .performance-area-name{padding-right:4px}.teacher-grade-analyzer .performance-area-row .performance-area-name b{letter-spacing:-.035em}.teacher-grade-analyzer .planned-performance-textarea{line-height:1.5!important}.teacher-grade-analyzer .teacher-grade-subtotal>small{line-height:1.45!important;color:#7a8899!important}.teacher-grade-analyzer .criteria-setting-card .teacher-grade-setting-caption{max-width:none}
...
const ui = {
  ...
  settingsGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(292px,1fr))", gap: 16, alignItems: "stretch" },
  settingCard: { minWidth: 0, border: "1px solid #d7e2ee", borderRadius: 17, padding: "18px 17px", background: "linear-gradient(180deg,#ffffff 0%,#f8fbfe 100%)", boxShadow: "0 4px 14px rgba(48,72,105,.035)" },
  settingTitleRow: { display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:14, marginBottom:14 },
  settingTitle: { marginBottom: 6, fontSize: 14.5, lineHeight: 1.3, fontWeight: 950, color: "#263b55", letterSpacing:"-.035em" },
  addAssessmentButton:{display:"inline-flex",alignItems:"center",gap:5,flex:"0 0 auto",border:"1px solid #b9cee4",borderRadius:10,padding:"8px 10px",color:"#315d90",background:"#eef6fd",fontWeight:900,fontSize:10.8,cursor:"pointer",whiteSpace:"nowrap"},
  weightRow: { display: "grid", gridTemplateColumns: "minmax(0,1fr) auto", gap: 16, alignItems: "center", minHeight: 60, padding: "13px 0", borderBottom: "1px solid #e3eaf2" },
  plannedWeightRow:{},
  ...
  weightActions: { display: "inline-flex", alignItems: "center", justifyContent: "flex-end", gap: 8, flexWrap: "wrap" },
  ...
  subtotal: { display: "grid", gridTemplateColumns:"1fr auto", gap:"4px 12px", alignItems:"center", marginTop: 15, padding:"13px 2px 0", color: "#526174", fontSize: 12.3, borderTop:"1px solid #d9e3ed" },
